...
import com.karmanov.auth.authservice.dto.response.UserCreatedRoom;
import com.karmanov.auth.authservice.dto.response.UserJoinedRoom;
import com.karmanov.auth.authservice.model.RoomEntity;
